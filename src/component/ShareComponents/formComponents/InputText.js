...
import {Util ,TextPopup,Icons} from '..'
import './style.css';
...
class InputText extends Component {
  ...
  render() {  
    ...
    var labelinputField = f_label?f_label:'';
    ...
    return (    
          <div className="inputStyle" ref={this.ref}>
            ...
            <TextPopup ref={this.refT} style={validStyle} >
                <div className="InputTextContainer">
                  <div className="IconInputTextModal">
                    <Icons name={icon} color={IconColor} size={24}/>
                  </div>
                  <div className="inputText2Alg">
                    <input type={inpuType} placeholder={placeholder} className="InputClass" onChange={this.handleChange} onBlur={this.handleblur}  onKeyUp={this.handleKeyUp} value={labelinputField}
                    style={textVStyle}/>
                  </div>
                </div>
            </TextPopup>
